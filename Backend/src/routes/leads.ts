...
/**
 * Intersection helper.
 * NOTE: no defaulted parameter followed by required ones (avoids TS1016).
 */
...
/**
 * NOTE: This router uses an absolute path because that’s what your current
 * index mounts expect. If you ever mount at "/api/leads", change the
 * .get() path here to just "/find-buyers".
 */
