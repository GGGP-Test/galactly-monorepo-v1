// src/index.ts
//
// Minimal Express bootstrap with strict CORS, tiny logger,
// canonical /api/* mounts, and a simple /healthz probe.
...
app.use((req: Request, res: Response, next: NextFunction) => {
  ...
  res.on("finish", () => {
    ...
    // keep clean & short; Northflank logs nicely
    console.log(
...
// Canonical JSON health (router handles details)
...
app.listen(port, () => {
  console.log(
    `buyers-api listening on :${port} (env=${CFG.nodeEnv}) — /healthz, /api/*`
  );
});
